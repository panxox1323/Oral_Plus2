		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li><a href="{{ route('secretaria.especialista.index') }}"><span class="icon-health"></span> <strong> Especialistas</strong></a></li>
					<li><a href="{{ route('secretaria.insumos.index') }}"><span class="icon-loop2"> <strong> Insumos</strong></span></a></li>
					<li><a href="{{ route('secretaria.proveedor.index') }}"><span class="icon-user-tie"></span> <strong> Proveedores</strong></a></li>
					<li><a href="{{ route('secretaria.especialidad.index') }}"><span class="icon-addressbook3"></span><strong> Especialidades</strong></a></li>
				</ul>
